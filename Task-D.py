...
def line2data(str):  # для преобразования строк в дату и потраченную сумму
    ...
    dt = datetime.strptime(inp[0] + ' ' + inp[1], '%Y-%m-%d %H:%M:%S')
...
dt_ini = datetime.strptime('2020-12-31 23:59:59', '%Y-%m-%d %H:%M:%S')
dt_end = datetime.strptime('2021-01-31 23:59:59', '%Y-%m-%d %H:%M:%S')
